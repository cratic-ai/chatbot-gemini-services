    ...
    return (
        <div className="flex flex-col h-full">
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold">Document Stores</h2>
                <div className="flex items-center space-x-2">
                     <button
                        onClick={onRefresh}
                        className="p-2 bg-cratic-subtle hover:bg-cratic-border rounded-full text-cratic-text-primary transition-colors disabled:opacity-50"
                        disabled={isLoading}
                    ...
                    <button
                        ...
                        className="p-2 bg-cratic-purple hover:bg-cratic-purple-hover rounded-full text-white transition-colors disabled:opacity-50"
                        disabled={isLoading}
            ...
            {isLoading && !stores.length ? (
                ...
                <div className="flex-grow flex items-center justify-center text-center text-cratic-text-secondary">
                    <p>No stores found. <br /> Click the '+' to create one.</p>
                </div>
            ) : (
                            ...
                            <button
                                ...
                                className={`w-full text-left p-3 rounded-md transition-colors text-lg ${
                                    selectedStore?.name === store.name
                                        ...
                                        : 'bg-cratic-subtle hover:bg-cratic-border'
                                }`}
